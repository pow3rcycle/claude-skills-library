# AI Tells - Forbidden Patterns (design-taste-frontend, Section 9)

> Split out of `SKILL.md` on 2026-08-12 to keep the skill body loadable. The SKILL.md keeps Section 9's heading, its non-negotiables, and a pointer here; the full catalogue lives below, unchanged. `MASTER-DESIGN.md` wins on any conflict.
...
### 9.B Typography
* **Inter is BANNED outright** (whole family). See Section 4.1 — there is no override path.
