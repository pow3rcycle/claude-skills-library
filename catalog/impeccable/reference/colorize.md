...
- **Flat surface steps**: Get depth from a hue-tinted surface ladder (base / raised / sunken, 2-4% lightness apart in OKLCH), not from a gradient. Gradient backdrops are banned - see the DON'T list below.
...
- **Flat color fields**: Solid brand-tinted panels or bands to break up a page (no gradient overlays, no mesh backgrounds)
